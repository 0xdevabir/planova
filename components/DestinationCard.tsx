        ...
        <div className="flex flex-col gap-2 pt-2">
          ...
          {onSelect && (
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 bg-white border border-cyan-200 text-cyan-700 hover:bg-cyan-50 hover:border-cyan-300 font-semibold py-2 rounded-xl transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-4.35-4.35M11 19a8 8 0 100-16 8 8 0 000 16z" />
              </svg>
              Search nearby {destination.name}
            </button>
          )}
        </div>
      </div>
